...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-500 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-900 hover:text-white transition-all duration-300"
          >
            <FaGithub size={20} />
          </a>
          <a
          ...
          <a
            ...
            className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-red-500 hover:text-white transition-all duration-300"
          >
            <FaEnvelope size={20} />
          </a>
        </div>
      ...
      {/* Copyright & Signature */}
      <div className="text-center py-5 text-gray-600 dark:text-gray-400 text-sm transition-colors duration-500">
        <p className="mb-1">
          &copy; {new Date().getFullYear()}{" "}
          <span className="font-semibold">SkillSwap</span>. All rights reserved.
        </p>
        <p className="text-gray-500 dark:text-gray-500 flex justify-center items-center gap-1">
          Made with <span className="text-red-500 animate-pulse">❤️</span> by{" "}
          <span className="font-semibold text-blue-600 dark:text-blue-400 hover:underline hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
            Mohammad Abed
          </span>
        </p>
      </div>
